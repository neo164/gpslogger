...
SET(CMAKE_C_FLAGS_RELEASE "-Os -g ${LTO_FLAG}" CACHE INTERNAL "c compiler flags release")
SET(CMAKE_CXX_FLAGS_RELEASE "-Os -g ${LTO_FLAG}" CACHE INTERNAL "cxx compiler flags release")
SET(CMAKE_ASM_FLAGS_RELEASE "-g ${LTO_FLAG}" CACHE INTERNAL "asm compiler flags release")
SET(CMAKE_EXE_LINKER_FLAGS_RELEASE "-g ${LTO_FLAG}" CACHE INTERNAL "linker flags release")
...
#TODO Fix this. It does not work for some reason
FUNCTION(STM32_GENERATE_MAP_FILE TARGET)
    ...
    ELSE()
      SET(FILENAME "${TARGET}")
    ENDIF()
    SET(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -Wl,-Map,${FILENAME}.map  -Wl,--cref")
ENDFUNCTION()
